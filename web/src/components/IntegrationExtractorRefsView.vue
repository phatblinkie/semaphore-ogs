<template>
  <div class="object-refs-view integration-extractor-refs-view">
    ...
    <div v-for="s in sections" class="object-refs-view__section" :key="s.slug">
      ...
      <div class="ml-6">
        ...
        >
          <router-link
            :to="`/project/${projectId}/integration/${t.integrationId}/extractor/${t.itemId}`"
            class="object-refs-view__link"
            >{{ t.name }}</router-link
          >
        </span>
      </div>
