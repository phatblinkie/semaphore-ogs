...
mkdir -p ~/repos/semaphore-ogs/rpmbuilder/tmp/${PACKAGE_NAME}-${VERSION}/etc/semaphore/config/
...
cp ~/repos/semaphore-ogs/config.json ~/repos/semaphore-ogs/rpmbuilder/tmp/${PACKAGE_NAME}-${VERSION}/etc/semaphore/config/
